...
// Validate checks the field values on SetTurtleBatchResp with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *SetTurtleBatchResp) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on SetTurtleBatchResp with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// SetTurtleBatchRespMultiError, or nil if none found.
func (m *SetTurtleBatchResp) ValidateAll() error {
	return m.validate(true)
}

func (m *SetTurtleBatchResp) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return SetTurtleBatchRespMultiError(errors)
	}

	return nil
}

// SetTurtleBatchRespMultiError is an error wrapping multiple validation errors
// returned by SetTurtleBatchResp.ValidateAll() if the designated constraints
// aren't met.
type SetTurtleBatchRespMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m SetTurtleBatchRespMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m SetTurtleBatchRespMultiError) AllErrors() []error { return m }

// SetTurtleBatchRespValidationError is the validation error returned by
// SetTurtleBatchResp.Validate if the designated constraints aren't met.
type SetTurtleBatchRespValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e SetTurtleBatchRespValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e SetTurtleBatchRespValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e SetTurtleBatchRespValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e SetTurtleBatchRespValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e SetTurtleBatchRespValidationError) ErrorName() string {
	return "SetTurtleBatchRespValidationError"
}

// Error satisfies the builtin error interface
func (e SetTurtleBatchRespValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sSetTurtleBatchResp.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = SetTurtleBatchRespValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = SetTurtleBatchRespValidationError{}
